...
local function channel_get_admins(channel,cb)
  local function callback_admins(extra,result,success)
    ...
    luaerror.getChannelMembers(channel, 0, 'Administrators', limit,cb)
     else return luaerror.sendText(channel,0, 1,'ابتدا ربات را ادمین کنید', 'html') end
    end
  luaerror.getChannelFull(channel,callback_admins)
end
...
local function callback_admins(extra,result,success)
    ...
    luaerror.getChannelMembers(channel, 0, 'Bots', limit,cb)
    end
  luaerror.getChannelFull(channel,callback_admins)
end
...
local function callback_admins(extra,result,success)
    ...
    luaerror.getChannelMembers(channel, 0, 'Kicked', limit,cb)
    end
  luaerror.getChannelFull(channel,callback_admins)
end
